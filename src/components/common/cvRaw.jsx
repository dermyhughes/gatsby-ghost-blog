            ...
            <section>
              <article>
                ...
                <div className="coverLetter sectionContent">
                  <p>
                    I&apos;m a UX Engineer based in Belfast, Northern Ireland,
                    with a focus on
                    {' '}
                    <a
            ...
            <section>
              ...
              <div className="sectionContent">
                <article>
                  ...
                  <p>
                    Front End Developer using React. Focusing on developing and
                    managing an internal design system of reusable React
                    components, Design Tokens, and more.
                  </p>
                </article>
                <article>
                  <h2>UX Developer</h2>
                  ...
                  <p>
                    Front End Development with a particular focus on UI and UX.
                    Worked on a series of projects both greenfield and legacy,
                    with a variety of stacks including Vue and Ruby on Rails.
                  </p>
                </article>
                <article>
                  ...
                  <p>
                    ...
                    Developing and maintaining an open and closed source design
                    system and UI Angular component library,
                ...
                <article className="second-job">
                  ...
                  <p>
                    Front End Development incorporating HTML5, CSS3, and
                    JavaScript ES6+/TypeScript using the Angular framework. UX
                    and UI Design for Web applications. Wireframing, rapid
                    prototyping, mockups, user research, and analytics. Public
                    facing sites and internal/client facing interfaces,
                    including front-end development and UX design. Email design
                    and development for award winning bank loyalty programmes.
                  </p>
                </article>
                <article>
                  ...
                  <p>
                    Lead Developer and Line Manager for the Email Marketing team
                    for Chain Reaction Cycles - The World&apos;s Largest Online
                    Bike Store. Responsible for the creation and delivery of
                    responsive mobile-first commercial and CRM emails worldwide.
                    Working to extreme deadlines and turnarounds as short as
                    hours.
                  </p>
                </article>
                <article>
              ...
              <div className="sectionContent">
                <article>
                  <p>
                    ...
                    biking, playing bass guitar, listening to new music,
                    watching ice hockey, cooking, and occasionally I’ve taken
                    part as an extra in TV and Film productions such as Game of
